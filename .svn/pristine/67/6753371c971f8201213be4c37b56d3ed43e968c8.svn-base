...
namespace login
{
    public partial class LoginForm : Form
    {
        ...
        private void loginButton_Click(object sender, EventArgs e)
        {
            ...
            {
                //LoginInfoのプロパティにログインユーザー情報を渡す
                LoginInfo.loginUserId = inputUserId.Text;
                LoginInfo.loginLastNm = this.lastNm;
                LoginInfo.loginFirstNm = this.firstNm;

                //ログイン履歴画面を開く
                his.ShowDialog();

                //ログイン履歴画面を閉じた時ログインユーザー情報を初期化する
                LoginInfo.loginUserId = "";
                LoginInfo.loginLastNm = "";
                LoginInfo.loginFirstNm = "";
                Console.WriteLine(LoginInfo.loginUserId + LoginInfo.loginLastNm + LoginInfo.loginFirstNm);
            }    
        }
